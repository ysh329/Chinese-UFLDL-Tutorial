...
注意上式中第三项， $\lVert A \rVert_2^2$ 等价于 $\sum_r{\sum_c{A_{rc}^2}}$ ，是 $A$ 中各项的平方和。
...
如果 $ε$ 远大于 $x$ ，则 $x + ε$ 的值将由 $ε$ 主导，其平方根近似于 $ε$ 。在下文提及拓扑稀疏编码时，“平滑”会派上用场。
...
其中， $\sqrt{s^2 + \epsilon}$ 是 $\sum_k{\sqrt{s_k^2 + \epsilon}}$ 的简写。
